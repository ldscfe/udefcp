...
// Function Statement
string isNULL( const string& str1 );                                                      // 字符串为空，返回中文空格, string str1
string isNULL( const string& str1, const string& str2 );                                  // 字符串为空，返回 str2
...
string strGet ( const string&, const string&, const string& );                            // 根据分隔符返回字符串
string strCut ( const string&, const string&, const string& );                            // 过滤所有间隔符间的字符
...
string lower( const string & str );                         //字母转换为小写
string upper( const string & str );                         //字母转换为大写

string to_str( const long& num );                           //数值转换为字符串
